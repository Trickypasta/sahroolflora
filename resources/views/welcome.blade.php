    ...
    <section class="relative h-[80vh] bg-cover bg-center text-white"
        ...
        <div class="relative z-10 h-full flex flex-col justify-end max-w-7xl mx-auto p-8 md:p-12">
            <div class="max-w-2xl">
                ...
                <p class="mt-4 text-lg md:text-xl text-gray-200 max-w-xl drop-shadow">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div>
                    ...
                    <h3 class="mt-4 text-lg font-semibold">Dukung Petani Lokal</h3>
                    <p class="mt-1 text-gray-600">Setiap pembelian Anda membantu perekonomian petani tanaman hias lokal.</p>
                </div>
                <div>
                    <div
                        class="mx-auto h-12 w-12 flex items-center justify-center rounded-full bg-green-100 text-green-700">
                    ...
                    <h3 class="mt-4 text-lg font-semibold">Garansi Tiba Sehat</h3>
                    <p class="mt-1 text-gray-600">Kami pastikan tanaman sampai ke tangan Anda dalam kondisi terbaik.</p>
                </div>
                <div>
                    <div
                        class="mx-auto h-12 w-12 flex items-center justify-center rounded-full bg-green-100 text-green-700">
                    ...
                    <h3 class="mt-4 text-lg font-semibold">Pengiriman Aman</h3>
                    <p class="mt-1 text-gray-600">Dikemas dengan hati-hati untuk melindungi setiap daun dan batang.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 sm:py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-left">
                    <h2 class="font-lora text-3xl md:text-4xl font-bold mb-4 text-gray-800">Dari Jurnal Tanaman Kami</h2>
                    <p class="text-lg text-gray-600 mb-8">Baca tips dan trik dari para ahli agar tanamanmu tumbuh subur dan
                        bahagia.</p>
                    <div class="space-y-4">
