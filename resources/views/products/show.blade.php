            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                    ...
                    <div class="mt-4 grid grid-cols-5 gap-4">
                        @foreach ($product->images as $image)
                            <button @click="mainImage = '{{ asset('storage/' . $image->path) }}'"
                                class="aspect-square w-full rounded-md overflow-hidden focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-600">
                ...
                <div class="sticky top-24">
                    ...
                    <form action="{{ route('cart.add', $product->id) }}" method="POST" class="mt-8"
                        ...
                        <div class="flex items-center mb-6">
                            ...
                            <div class="flex items-center border border-gray-300 rounded-md">
                                ...
                                <input type="text" name="quantity" x-model="quantity"
                                    class="w-12 text-center border-l border-r border-gray-300" readonly>
                        ...
                        <button type="submit"
                            class="w-full bg-green-700 text-white font-bold py-4 px-6 rounded-full hover:bg-green-800 transition-colors duration-300 text-lg">
                            Tambah ke Keranjang
                        </button>
                    </form>
                    ...
                    <div class="mt-10 border-t border-gray-200">
                        <div x-data="{ open: true }" class="border-b border-gray-200 py-6">
                            <h3>
                                <button @click="open = !open"
                                    class="flex items-center justify-between w-full text-left text-gray-600">
                        ...
                        <div x-data="{ open: false }" class="border-b border-gray-200 py-6">
                            ...
                            <div x-show="open" x-collapse class="pt-4 prose prose-sm max-w-none text-gray-600">
                                {!! nl2br(e($product->care_guide ?? 'Informasi perawatan belum tersedia untuk produk ini.')) !!}
                            </div>
                        </div>
                    </div>
